#
#  Be sure to run `pod spec lint ZJDefine.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/gnaw9258wp/ZJDefine", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "ZJDefine/ZJDefine/Class/**/*.{h,m}"
